...
export const OrderStatusEmail = ({ 
  ...
  const isShipped = status.toLowerCase() === "shipped" || status.toLowerCase() === "out_for_delivery";
  const isDelivered = status.toLowerCase() === "delivered";
  
  const statusMessage = isShipped 
    ? "Great news! Your delicious order is on the way." 
    : isDelivered 
    ...
    <Html>
      ...
      <Tailwind>
        <Body className="bg-[#fafafa] my-auto mx-auto font-sans">
          <Container className="border border-solid border-[#eaeaea] bg-white rounded my-[40px] mx-auto p-[20px] w-[600px]">
            <Section className="mt-[32px]">
              <Text className="text-[#ff7a7a] text-[28px] font-bold text-center p-0 my-[30px] mx-0" style={{ fontFamily: 'Georgia, serif' }}>
                Slice of Cake
              </Text>
            </Section>
