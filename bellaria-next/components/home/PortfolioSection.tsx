...
const PortfolioSection = () => {
    // This defines the blocks for the portfolio. In a real app, this would come from an API.
    const portfolioItems = [1, 2, 3, 4, 1, 2, 3, 4]; // Dummy loop to replicate the 8 items
    ...
    return (
        <section className="portfolio-section">
            <div className="auto-container">
                ...
                <div className="row">
                    {/* Replicating the static blocks */}
                    {portfolioItems.map((item, index) => (
                        <div className="portfolio-block col-lg-3 col-md-6 col-sm-12" key={index}>
                            <div className="inner-box">
                                <div className="image-box">
                                    <figure className="image"><img src="/assets/images/resource/donuts.png" alt="" /></figure>
                                </div>
                                <div className="portfolio-hover">
                                    ...
                                    <a href="/assets/images/resource/donuts.png" className="lightbox-image link" data-fancybox="portfolio"></a>
                                    <h3><Link href="#">Nulla diam <br />tellus</Link></h3>
                                </div>
                            </div>
                        </div>
                    ))}
