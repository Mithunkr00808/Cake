...
const ServicesSection = () => {
    ...
    useEffect(() => {
        ...
        const initCarousel = () => {
            if (carouselRef.current && $(carouselRef.current).owlCarousel) {
    ...
    return (
        <section className="services-section" style={{ backgroundImage: 'linear-gradient(rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0.1)), url(/assets/images/background/services-bg.jpg)' }}>
            <div className="auto-container">
                ...
                {/* Services Carousel */}
                <div ref={carouselRef} className="services-carousel owl-carousel owl-theme">
                            ...
                            <div className="inner-box">
                                <div className="image-box">
                                    ...
                                    <figure className="image">
                                        <Link href={`/shop?category=${encodeURIComponent(service.title)}`}>
                                            <img
                                                src={service.image}
                                                alt={service.title}
                                            />
                                ...
                                <h3>
                                    <Link href={`/shop?category=${encodeURIComponent(service.title)}`} style={{ color: 'inherit', textDecoration: 'none' }}>
                                        {service.title}
                                    </Link>
                                </h3>
