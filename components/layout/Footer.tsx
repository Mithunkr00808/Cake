...
const Footer = ({ facebook, instagram }: { facebook?: string, instagram?: string }) => {
            ...
            <div className="widgets-section">
                <div className="auto-container">
                    <div className="row">
                        ...
                        {/* Footer Column - Logo with Image Removed */}
                        <div className="footer-column col-lg-4 col-md-12 col-sm-12">
                            <div className="footer-widget logo-widget">
                                {/* Image removed as requested, keeping structure */}
                            </div>
                        </div>
                                ...
                                <div className="newslatter-form">
                                    <form method="post" action="#" id="subscribe-form">
                                        ...
                                        <div className="form-group">
                                            <input type="email" name="email" className="email" style={{ backgroundColor: '#ffffff', color: '#000000' }} placeholder="Your Email Address" required />
